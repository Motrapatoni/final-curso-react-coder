...
import logoLight from '../../../assets/images/logo-navbar.svg'
            ...
            <div className={`${open ? '-left-6' : '-left-full'} w-full duration-500 h-screen z-0 absolute top-0 border ${darkMode ? "bg-dark-blue border-dark-gray-text" : "bg-white border-light-gray" }`}>
                <nav className='flex flex-col'>
                    <div className='flex justify-center min-w-0 items-center min-h-0 shrink-0 h-[67px]'>
                        <img src={darkMode ? logoLight : logo} alt="kwik-e-mark" className='h-4 border-0'/>
                    ...
                    <div className='min-w-0 flex flex-col h-full min-h-0'>
                        ...
                        <button onClick={()=>setOpen(!open)}>
                            <SideCategories titulo ="Congelados"
                            ruta ="/category/congelados"/>
                        </button>
                        <hr className={`w-full ${darkMode ? "text-dark-gray-text" : "text-light-gray" }`}/>
                        <button onClick={()=>setOpen(!open)}>
                            <SideCategories titulo ="Bebidas"
                            ruta ="/category/bebidas"/>
                        </button>
                        <hr className={`w-full ${darkMode ? "text-dark-gray-text" : "text-light-gray" }`}/>
                        <button onClick={()=>setOpen(!open)}>
                            <SideCategories titulo ="Cereales"
                            ruta ="/category/cereales"/>
                        </button>
                        <hr className={`w-full ${darkMode ? "text-dark-gray-text" : "text-light-gray" }`}/>
                        <button onClick={()=>setOpen(!open)}>
                            <SideCategories titulo ="Comics"
                            ruta ="/category/comics"/>
                        </button>
                        <hr className={`w-full ${darkMode ? "text-dark-gray-text" : "text-light-gray" }`}/>
                        <button onClick={()=>setOpen(!open)}>
                            <SideCategories titulo ="Ropa"
                            ruta ="/category/ropa"/>
                        </button>
                        <hr className={`w-full ${darkMode ? "text-dark-gray-text" : "text-light-gray" }`}/>
                    </div>
